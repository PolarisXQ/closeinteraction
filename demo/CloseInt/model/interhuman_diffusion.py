...
class interhuman_diffusion(nn.Module):
    def __init__(self, smpl, frame_length=16, smooth=False, **kwargs):
        ...
        if self.use_text:
            ...
            self.token_embedding = clip_CloseInt.model.token_embedding
            self.clip_transformer = clip_CloseInt.model.transformer
            self.positional_embedding = clip_CloseInt.model.positional_embedding
            self.ln_final = clip_CloseInt.model.ln_final
            self.dtype = clip_CloseInt.model.dtype
