...
def parse_config(argv=None):
    ...
    parser.add_argument('--frame_length',
                        ...
                        type=int,
                        help='frame_length.')
    parser.add_argument('--body_model',
                        default='smpl',
                        type=str,
                        help='ee_train: encoder-encoder only, else ed_train.')
    parser.add_argument('--smooth',
                        default=False,
                        type=lambda x: x.lower() in ['true', '1'],
                        help='True for smooth.')
    parser.add_argument('--use_classifier_guidance',
                        default=False,
                        type=lambda x: x.lower() in ['true', '1'],
                        help='True for use_classifier_guidance.')
    parser.add_argument('--scale_factor',
                        default=1000000.0,
                        type=float,
                        help='scale factor for classifier guidance.')
    parser.add_argument('--base_model',
                        default='',
                        type=str,
                        help='base model for control_net')
    parser.add_argument('--sub_sequence',
                        default='',
                        type=str,
                        help='sub sequence for evaluation')
